define('Sonatype/repoServer/DependencyManagementPanel', function () {
    ...
    Sonatype.Events.addListener('fileContainerInit', function(items) {
        items.push(new Sonatype.repoServer.DependencyManagementPanel({
            name: 'dependencyManagementPanel',
            tabTitle: 'Dependency Management',
            preferredIndex: 50
        }))
    });
